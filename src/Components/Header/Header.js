...
export default function Header() {
    ...
    const [Menu, setMenu] = useState([
        ...
        { id: 4, title: "بلاگ",logoId:'#text' },
        { id: 5, title: "درباره ما",logoId:'#brief-case' },
        { id: 6, title: "تماس با ما",logoId:'#phone' },
    ])
      ...
      <>
        <header className='hidden z-50 lg:flex fixed top-9 left-0 right-0  bg-black/50 w-[90%] h-24 mx-auto items-center rounded-2xl py-5 px-10 text-xl backdrop-blur-[6px]'>
            <div className='flex justify-between w-full items-center '>
                ...
                <svg className='hidden'>
                    ...
                    <symbol id='brief-case' xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" >
                         <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 14.15v4.25c0 1.094-.787 2.036-1.872 2.18-2.087.277-4.216.42-6.378.42s-4.291-.143-6.378-.42c-1.085-.144-1.872-1.086-1.872-2.18v-4.25m16.5 0a2.18 2.18 0 0 0 .75-1.661V8.706c0-1.081-.768-2.015-1.837-2.175a48.114 48.114 0 0 0-3.413-.387m4.5 8.006c-.194.165-.42.295-.673.38A23.978 23.978 0 0 1 12 15.75c-2.648 0-5.195-.429-7.577-1.22a2.016 2.016 0 0 1-.673-.38m0 0A2.18 2.18 0 0 1 3 12.489V8.706c0-1.081.768-2.015 1.837-2.175a48.111 48.111 0 0 1 3.413-.387m7.5 0V5.25A2.25 2.25 0 0 0 13.5 3h-3a2.25 2.25 0 0 0-2.25 2.25v.894m7.5 0a48.667 48.667 0 0 0-7.5 0M12 12.75h.008v.008H12v-.008Z" />
                    </symbol>
                    <symbol id='text' xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                    ...
                    <symbol id="arrow-down" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" >
        ...
        <div className='flex lg:hidden overflow-y-auto items-center justify-between bg-white dark:bg-zinc-700 px-5 h-16 child:text-white'>
            {/* Nav Mobile */}
             ...
             {/* menu */}
             <div className={`${IsMenu ? 'right-64 transition-all duration-1000 fixed top-0 bottom-0 w-64 bg-white dark:bg-zinc-700 z-20 min-h-screen  px-4 pt-3' : '-right-64 duration-1000  fixed top-0 bottom-0 w-64 bg-white dark:bg-zinc-700 z-20 min-h-screen  px-4 pt-3' }`}>
                    {/* Header Nav */}
                    <div className='flex  justify-between text-orange-300 items-center h-10 w-[155px] border-b gap-x-12 pb-5 border-gray-100 mt-3'>
                        ...
                        <div onClick={closeMenu} >
                            <svg className='h-5 w-5 text-zinc-700'>
                                <use href='#delete'>
                    ...
                    <div className='border-b border-gray-100  my-4'>
                        <ul className='child:pr-2.5 dark:text-white text-zinc-600 text-sm font-Dana tracking-tighter space-y-6  pb-4'>
                            {Menu.map(menu=>(
                                <div>
                                    <li onClick={showSubMenu} key={menu.id}  className={`${menu.id==1 ? 'child:text-orange-300 bg-orange-200/20 h-10 flex items-center rounded-md pr-2.5 text-orange-300' :'bg-white flex gap-x-28 items-center'}`}> 
                                    
                                   
                                        <a className='flex gap-x-2' href='#' >
                                             <svg className='w-5 h-5  dark:text-white hover:text-orange-300'>
                                                <use href={menu.logoId}></use>
                                             </svg>  
                                             <span> {menu.title}</span>    
                                       </a>
                                       {menu.subMenu && (
                                            <svg className='w-2 h-2 text-orange-300'>
                                    ...
                                    {menu.subMenu && IsSubMenu && (
                                        <div className='tracking-tighter space-y-3 mt-3 pr-7'>
                                            {menu.subMenu.map(subMenu=>(
                                                <a className='block' key={subMenu.id}>{subMenu.title}</a>
                                            ))}
                                        </div>
                                    )}
                    ...
                    {/* Footer Div */}
                    <div className='inline-block text-orange-300 text-sm font-Dana tracking-tighter space-y-6 pr-2.5'>
            ...
            {/* Logo Type */}
             <div>
                ...
                <svg className='w-[100px]  h-2.5 dark:text-orange-300'> 
                    <use href='#logo-type'></use>
                </svg>
             </div>
            {/* Cart */} 
